...
public class BooKingHistoryOfTeacherController extends ControllerBase {
    ...
    public ResponseEntity<?> getHistoryDetails(@PathVariable(name = "detail_id") int detail_id){
        ...
        try {
            ...
            if(details !=null){
                String acceptTime ;
                if(details.getAcceptTime() ==null){
                    acceptTime = "";
                }else{
                    acceptTime = inputDateFormat.format(details.getAcceptTime());
                }
                HistoryOfTeacherDTO bookingRoomHistoryOfTeacher = new HistoryOfTeacherDTO(
                        ...
                        inputDateFormat.format(details.getReserveTime()),inputDateFormat.format(details.getEndTime()),inputDateFormat.format(details.getReturnTime()),acceptTime ,details.getStatus()
