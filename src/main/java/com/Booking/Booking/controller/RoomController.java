...
//	@PutMapping("/editroom/{id}")
	public ResponseEntity<?> EditRoom(@RequestParam(name = "file", required = false) MultipartFile file,
									  ...
									  @RequestParam(name = "area", required = false) double area,
									  @RequestParam(name = "status", required = false) int status,
									  @RequestParam(name = "description", required = false) String description,
									  @RequestParam(name = "countofseats", required = false) int countofseats,
									  @RequestParam(name = "typeid", required = false) int typeid,
...
//	@GetMapping("/getallroom")
	public ResponseEntity<?> getAllRoom(@RequestParam(value = "page" , required = false ,defaultValue = "0") String page){
		try {
			if(page.isEmpty()) {
				page = "0";
			}
